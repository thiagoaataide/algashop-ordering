...
import com.algaworks.algashop.ordering.infrastructure.persistence.order.OrdersPersistenceEntityRepository;
...
class OrdersPersistenceEntityRepositoryIT {
    ...
    @Autowired
    public OrdersPersistenceEntityRepositoryIT(OrdersPersistenceEntityRepository ordersPersistenceEntityRepository, CustomerPersistenceEntityRepository customerPersistenceEntityRepository) {
    ...
    public void setup() {
        ...
        if(!customerPersistenceEntityRepository.existsById(customerId)){
            customerPersistenceEntity = CustomerPersistenceEntityTestDataBuilder.aCustomer().id(customerId).build();
