...
class OrdersIT {
    ...
    public void shouldReturnTotalSoldByCustomer(){
        ...
        Assertions.assertThat(orders.totalSoldForCustomer(CustomerTestDataBuilder.DEFAULT_CUSTOMER_ID)).isEqualTo(expectedTotalAmount);
    ...
    public void shouldReturnSalesQuantityByCustomerInYear(){
        ...
        Assertions.assertThat(orders.salesQuantityByCustomerInYear(CustomerTestDataBuilder.DEFAULT_CUSTOMER_ID, Year.now())).isEqualTo(2L);
        Assertions.assertThat(orders.salesQuantityByCustomerInYear(CustomerTestDataBuilder.DEFAULT_CUSTOMER_ID, Year.now().minusYears(1))).isEqualTo(0L);
    }
}